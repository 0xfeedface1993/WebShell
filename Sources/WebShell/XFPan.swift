...
class XFPan: PCWebRiffle {
    var fileNumber = ""
    let hostName = "www.xfpan.cc"
    var fileMain = ""
    ...
    override func begin() {
        ...
        let one = self.onePage
        let middle = self.middlePage
        
        loadPage(url: one, header: ["Accept-Language":"zh-cn",
                                    "Upgrade-Insecure-Requests":"1",
                                    "Accept-Encoding":"gzip, deflate",
                                    "Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
                                    "User-Agent":userAgent], callback: { [weak self] task in
                                        loadPage(url: middle, header: ["Accept-Language":"zh-cn",
                                                                       "Upgrade-Insecure-Requests":"1",
                                                                       "Accept-Encoding":"gzip, deflate",
                                                                       "Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
                                                                       "User-Agent":userAgent,
                                                                       "Referer":one.absoluteString], callback: { [weak self] task in
